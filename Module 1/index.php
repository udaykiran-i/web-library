      ...
      if (isset($_POST['username'])) {
          ...
          if ($rows == 1) {
              ...
              echo "<div class='error-msg'>
                    <h2 style='text-align:center;'>Incorrect Username/password.</h2><br/>
                    <p class='link'>Click here to <a href='index.php'  style='text-decoration:underline;color:white'>Login</a> again.</p>
                    </div>";
          }
      } else {
    ?>
